                ...
                { groupedByTagsExperiments && <Box px={2} pt={1.25}>
                    {Object.entries(groupedByTagsExperiments).map(([tag, experimentsUnderTag], tagIndex) => (
                        <Box key={tag}>
                            ...
                            <Typography sx={{ fontWeight: 'bold', mt: tagIndex !== 0 ? 2 : 0, mb: 1 }}>{tag}</Typography>
                            {experimentsUnderTag.map((experiment, experimentIndex) => {
                                const experimentActivityMaps = experimentsActivityMaps[experiment.name] || [];
                                return (
                                    <Box key={experiment.name}>
                                        ...
                                        <Box sx={{
                                            ...
                                            {experimentIndex === 0 && currentExperiment === experiment.name && <Chip label="Current Experiment" />}
                                        </Box>
                                        <FormGroup>
