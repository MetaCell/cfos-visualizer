  ...
  return (
    <Box pb={ 1.5 }>
      ...
      <Box sx={ tableStyles.body }>
        { tableContent?.map( ( row, index ) => <TableRow length={ tableContent?.length } data={ row } key={ index } index={ index } /> ) }
        <Box className="secondary" justifyContent='space-between' sx={{ ...tableStyles.root, background: headerBorderColor , border: `0.0625rem solid ${headerBorderLeftColor}`}}>
